...
class BlackAndWhiteGrating(visual.PlanarVisual):
    ...
    def __init__(self, *args):
        ...
        # Set up program
        self.grating = gloo.Program(self.load_vertex_shader('./planar_grating.vert'),
                                    self.load_shader('./planar_grating.frag'))
...
class WhiteAndBlackGrating(visual.PlanarVisual):
    description = 'White and black contrast grating stimulus'
    ...
    def __init__(self, *args):
        ...
        # Set up program
        self.grating = gloo.Program(self.load_vertex_shader('./spherical_grating.vert'),
                                    self.load_shader('./spherical_grating.frag'))
        self.grating['a_position'] = self.position_buffer
