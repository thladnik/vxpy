...
class DisplaySettings(QtWidgets.QWidget):
    ...
    def _setupUi(self):
        ...
        self._dspn_x_pos.setValue(Config.Display[DisplayConfig.pos_glob_x_pos])
        ...
        self._dspn_y_pos.setValue(Config.Display[DisplayConfig.pos_glob_y_pos])
        ...
        self._dspn_vp_center_offset.setValue(Config.Display[DisplayConfig.pos_glob_radial_offset])
        ...
        self._dspn_elev_angle.setValue(Config.Display[DisplayConfig.view_elev_angle])
        ...
        self._dspn_azim_angle.setValue(Config.Display[DisplayConfig.view_azim_angle])
        ...
        self._dspn_view_distance.setValue(Config.Display[DisplayConfig.view_distance])
        ...
        self._dspn_scale.setValue(Config.Display[DisplayConfig.view_scale])
        ...
        self._dspn_x_pos.valueChanged.connect(
            lambda: self.setConfig(DisplayConfig.pos_glob_x_pos, self._dspn_x_pos.value()))
        self._dspn_y_pos.valueChanged.connect(
            lambda: self.setConfig(DisplayConfig.pos_glob_y_pos, self._dspn_y_pos.value()))
        self._dspn_elev_angle.valueChanged.connect(
            lambda: self.setConfig(DisplayConfig.view_elev_angle, self._dspn_elev_angle.value()))
        self._dspn_azim_angle.valueChanged.connect(
            lambda: self.setConfig(DisplayConfig.view_azim_angle, self._dspn_azim_angle.value()))
        self._dspn_vp_center_offset.valueChanged.connect(
            lambda: self.setConfig(DisplayConfig.pos_glob_radial_offset, self._dspn_vp_center_offset.value()))
        self._dspn_view_distance.valueChanged.connect(
            lambda: self.setConfig(DisplayConfig.view_distance, self._dspn_view_distance.value()))
        self._spn_screen_id.valueChanged.connect(
            lambda: self.setConfig(DisplayConfig.window_screen_id, self._spn_screen_id.value()))
        self._check_fullscreen.stateChanged.connect(
            lambda: self.setConfig(DisplayConfig.window_fullscreen, Conversion.QtCheckstateToBool(self._check_fullscreen.checkState())))
        self._dspn_scale.valueChanged.connect(
            lambda: self.setConfig(DisplayConfig.view_scale, self._dspn_scale.value()))
    ...
    def updateGUI(self):
        ...
        if DisplayConfig.pos_glob_x_pos in _config \
                and _config[DisplayConfig.pos_glob_x_pos] != self._dspn_x_pos.value():
            self._dspn_x_pos.setValue(_config[DisplayConfig.pos_glob_x_pos])

        if DisplayConfig.pos_glob_y_pos in _config \
                and _config[DisplayConfig.pos_glob_y_pos] != self._dspn_y_pos.value():
            self._dspn_y_pos.setValue(_config[DisplayConfig.pos_glob_y_pos])

        if DisplayConfig.view_elev_angle in _config \
                and _config[DisplayConfig.view_elev_angle] != self._dspn_elev_angle.value():
            self._dspn_elev_angle.setValue(_config[DisplayConfig.view_elev_angle])

        if DisplayConfig.view_azim_angle in _config \
                and _config[DisplayConfig.view_azim_angle] != self._dspn_azim_angle.value():
            self._dspn_azim_angle.setValue(_config[DisplayConfig.view_azim_angle])

        if DisplayConfig.pos_glob_radial_offset in _config \
                and _config[DisplayConfig.pos_glob_radial_offset] != self._dspn_vp_center_offset.value():
            self._dspn_vp_center_offset.setValue(_config[DisplayConfig.pos_glob_radial_offset])

        if DisplayConfig.view_distance in _config \
                and _config[DisplayConfig.view_distance] != self._dspn_view_distance.value():
            self._dspn_view_distance.setValue(_config[DisplayConfig.view_distance])

        if DisplayConfig.view_scale in _config \
                and _config[DisplayConfig.view_scale] != self._dspn_scale.value():
            self._dspn_scale.setValue(_config[DisplayConfig.view_scale])

        if DisplayConfig.window_screen_id in _config \
                and _config[DisplayConfig.window_screen_id] != self._spn_screen_id.value():
            self._spn_screen_id.setValue(_config[DisplayConfig.window_screen_id])

        if DisplayConfig.pos_glob_x_pos in _config \
                and _config[DisplayConfig.window_fullscreen] != \
                Conversion.QtCheckstateToBool(self._check_fullscreen.checkState()):
            self._check_fullscreen.setCheckState(
                Conversion.boolToQtCheckstate(_config[DisplayConfig.window_fullscreen]))
