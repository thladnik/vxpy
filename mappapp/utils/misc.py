"""
MappApp ./misc.py - Collections of utils functions and classes.
...
class ConfigParser(configparser.ConfigParser):
    ...
    def read(self, filenames, encoding=None):
        if isinstance(filenames, list):
            filenames = [os.path.join(Def.package, Def.Path.Config,f) for f in filenames]
        else:
            filenames = os.path.join(Def.package, Def.Path.Config,filenames)
